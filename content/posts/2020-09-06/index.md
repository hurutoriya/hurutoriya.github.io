...
MLOpsという言葉が誕生して久しいですが、何をやるべきなのかが構造化されてきていて、機械学習と現実世界の橋渡しとしてどんどん掘り進められていくと思います。


機械学習エンジニアとして働いていく中で、今年の頭から関わっている自然言語処理を活用した機械学習プロジェクトも何かしらの形で論文に残そうと画策しています。

とてもエキサイティングな領域だと自分は思っているので、もしOpMLの発表が面白いと感じた方は、来年のOpML21の口頭発表にも申し込んでみてはいかがでしょうか?
